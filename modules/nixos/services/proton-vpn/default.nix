{
  ...
  inherit (lib.types) bool str port path;
  inherit (lib.modules) mkIf;

  cfg = config.cosmos.services.proton-vpn;
in {
  options.cosmos.services.proton-vpn = {
    enable = mkEnableOption "ProtonVPN (using Wireguard).";
